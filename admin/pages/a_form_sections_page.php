...
final class AdminAFormSectionsPage {
  ...
  public static function editPage() {
    AdminAFormSectionsPage::common_header();
      // Display Edit Page
      $a_form = AFormsTomM8::get_row_by_id("a_form_sections", "*", "ID", esc_html($_GET["id"])); ?>
  ...
  public static function render_admin_a_form_sections_form($instance, $action) { 
    if ($instance != null) {
      $form = AFormsTomM8::get_row_by_id("a_form_forms", "*", "ID", $instance->form_id);?>
    ...
    AFormsTomM8::add_form_field($instance, "hidden", "ID", "form_id", "form_id", array(), "span", array("class" => "hidden"));
    AFormsTomM8::add_form_field($instance, "text", "Name *", "section_name", "section_name", array("class" => "text"), "p", array());

    $fields = AFormsTomM8::get_results("a_form_fields", "*", "section_id=".$instance->ID, $order_array = array("field_order ASC"), $limit = "");
    $index = 0;
    ?>
